<x-layouts.app :title="__('Dashboard')">
    ...
    @include('partials.day-table', ['dayName' => 'Ponedeljak', 'exercises' => $monday])
    @include('partials.day-table', ['dayName' => 'Utorak',    'exercises' => $tuesday])
    @include('partials.day-table', ['dayName' => 'Sreda',     'exercises' => $wednesday])
    @include('partials.day-table', ['dayName' => 'Cetvrtak',  'exercises' => $thursday])
    @include('partials.day-table', ['dayName' => 'Petak',     'exercises' => $friday])
    @include('partials.day-table', ['dayName' => 'Subota',    'exercises' => $saturday])
    @include('partials.day-table', ['dayName' => 'Nedelja',   'exercises' => $sunday])
</div>
        </div>
        <div class="overflow-hidden  mt-4 rounded-xl border border-neutral-200 dark:border-neutral-700 p-4">
